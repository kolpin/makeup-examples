(function($){ 
        $.Placeholder = {
                ...
                init : function(settings){
                        ...
                        $('head').append('<style type="text/css">input:focus::-moz-placeholder {color:transparent!important;}input:focus::-webkit-input-placeholder {color:transparent!important;}</style>');
